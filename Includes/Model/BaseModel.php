...
abstract class BaseModel
{
     ...
     * @var array
     */
    static protected array $table_fields = ['id' => 'int'];
    /**
    ...
    static function count(array $fields, $search = '', $additional_fields = array())
    {
     ...
     * @return array(self)
     */
    protected static function createObjectsFromQuery($pdo_result)
    {
        $models = [];
