<div class="product-item" product-id="<?php echo $product->get_id() ?>" price="<?php echo $product->get_price() ?>">
    <a href="<?php $product->get_absolute_url(); ?>" class="product-item__image image image-cover">
    ...
    <div class="product-item__inner">
        <div class="top">
            <a href="<?php $product->get_absolute_url(); ?>" class="product-item__title clamp clamp-2">
